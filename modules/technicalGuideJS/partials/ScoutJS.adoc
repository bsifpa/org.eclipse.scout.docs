...
By the way: Scout JS is used in classic Scout applications as well.
This means, if you understand the concepts of Scout JS, writing custom widgets for Scout Classic will be a lot easier.
...
image::{imgsdir}/widget_model.png[]
...
image::{imgsdir}/typed_widget.png[]
...
As seen in the <<Creating a Widget>> a widget may be created using `scout.create`.
...
image::{imgsdir}/scoutjs_code_completion.png[]
* *Easier entry* +
